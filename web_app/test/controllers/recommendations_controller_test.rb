...
class RecommendationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post recommendations_url, params: { recommendation: { course: @recommendation.course, notes: @recommendation.notes, pemail: @recommendation.pemail, professor: @recommendation.professor, semail: @recommendation.semail, student: @recommendation.student } }
    end
  ...
  test "should update recommendation" do
    patch recommendation_url(@recommendation), params: { recommendation: { course: @recommendation.course, notes: @recommendation.notes, pemail: @recommendation.pemail, professor: @recommendation.professor, semail: @recommendation.semail, student: @recommendation.student } }
