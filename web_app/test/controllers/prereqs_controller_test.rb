...
class PrereqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prereq" do
    assert_difference('Prereq.count') do
      post prereqs_url, params: { prereq: { courseNumber: @prereq.courseNumber, req: @prereq.req } }
    end
  ...
  test "should update prereq" do
    patch prereq_url(@prereq), params: { prereq: { courseNumber: @prereq.courseNumber, req: @prereq.req } }
