...
class DirectoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create directory" do
    assert_difference('Directory.count') do
      post directories_url, params: { directory: { email: @directory.email, professor: @directory.professor, staff: @directory.staff } }
    end
  ...
  test "should update directory" do
    patch directory_url(@directory), params: { directory: { email: @directory.email, professor: @directory.professor, staff: @directory.staff } }
